...
import com.github.mrlmarlon.wrapper.AtividadeWrapper;
...
/**
 * Created by Marlon on 31/08/2022.
 */
public class ConsultasTests {
    ...
    public void ConsultaCnpjGoogle() {
        ...
        assertEquals("GOOGLE BRASIL INTERNET LTDA.", rw.getRazao_social());
...
//        assertThat(retorno, CoreMatchers.containsString("06.990.590/0002-04"));
    ...
    public void ConsultaCnpjGlobo() {
        ...
        assertEquals("GLOBO COMUNICACAO E PARTICIPACOES S/A", rw.getRazao_social());
